...
public enum DataDatabase {    
        ...
        Introduction ("Uvod","1-2-1-1-1-3",new DataElement[]{DataElement.PRINTED , DataElement.HEAD, DataElement.HEAD_LINK }),
        EventFuture("Pozvanky","1-2-1-4", new DataElement[]{DataElement.PRINTED,DataElement.HEAD, DataElement.DAY,DataElement.MONTH,
        DataElement.YEAR,DataElement.HOUR,DataElement.MINUTE,DataElement.HEAD_LINK,DataElement.PLACE,DataElement.TEXT,
        ...
        Petition("peticni stanky","1-2-1-9-1",new DataElement[]{DataElement.HEAD, DataElement.HEAD_LINK,DataElement.TEXT}),
        Plan("planuje se","1-2-1-11-1-1-1-1",new DataElement[] {DataElement.PRINTED,DataElement.HEAD_LINK,DataElement.TEXT}),
        PlanAdvertisement("planuje se reklama","1-2-1-11-2", new DataElement[]{DataElement.PRINTED}),
